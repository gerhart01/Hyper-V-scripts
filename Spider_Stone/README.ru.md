...
> Честно: единственный внешний онлайн-проект, из которого заимствована техника, —
> это **wcpex**. Остальное — разбор системных структур и стандартные API, без
> копирования кода из сети.
