...
hvcalls_dict = {
    ...
    0x0005: 'HvUpdateHvProcessorFeatures',       #winhvr.sys (09.2019)
    0x0006: 'HvUnknown01',
    0x0007: 'HvCondenseMicrocode',               #ntoskrnl.exe, HvDynamicUpdateMicrocode has same microcode
    ...
    0x0017: 'HvLoadHypervisorPatch01',           #securekernel.exe, ShvlLoadHypervisorPatch
    0x0018: 'HvLoadHypervisorPatch02',           #securekernel.exe, ShvlLoadHypervisorPatch
    0x0019: 'HvCallReserved00',
    0x001a: 'HvCallReserved00',
    0x001b: 'HvUnknown02',
    0x001c: 'HvReadPerfRegister',                #ntoskrnl.exe, Fast hypercall
    ...
    0x0052: 'HvTranslateVirtualAddress',             #used by securekernel.exe
    0x0053: 'HvReadGpa',
    0x0054: 'HvWriteGpa',
    ...
    0x005E: 'HvSavePartitionState',                  #HvCancelSavePartitionState in latest winhvr.sys (09.2019), HvSavePartitionState has same Hypercall ID
    0x005F: 'HvRestorePartitionState',               #HvCancelRestorePartitionState in latest winhvr.sys (09.2019)
    ...
    0x00AA: 'HvUnknown19',
    0x00AB: 'HvUnknown20',
    0x00AC: 'HvTranslateVirtualAddress01',           #winhvr.sys. Early it has hypercall id 0x52
    0x00AD: 'HvCheckForIoIntercept',	             #winhvr.sys
    0x00AE: 'HvSetGpaPageAttributes',                #securekernel.exe
    0x00AF: 'HvCallFlushGuestPhysicalAddressSpace',
    0x00B0: 'HvCallFlushGuestPhysicalAddressList',
        #2019
    0x00B1: 'HvUnknown21',
    0x00B2: 'HvAttachDeviceDomain',                  #securekernel.exe
    0x00B3: 'HvMapDeviceGpaPages',                   #securekernel.exe
    0x00B4: 'HvUnmapDeviceGpaPages',                 #securekernel.exe
    0x00B5: 'HvCreateCpuGroup',                      #winhvr.sys
    0x00B6: 'HvDeleteCpuGroup',                      #winhvr.sys
    0x00B7: 'HvGetCpuGroupProperty',                 #winhvr.sys
    0x00B8: 'HvSetCpuGroupProperty',                 #winhvr.sys
    0x00B9: 'HvGetCpuGroupAffinity',                 #winhvr.sys
    0x00BA: 'HvHvGetNextCpuGroup',                   #winhvr.sys
    0x00BB: 'HvGetNextCpuGroupPartition',            #winhvr.sys
    0x00BC: 'HvUnknown24',
    0x00BD: 'HvCompleteIntercept',                   #winhvr.sys
    0x00BE: 'HvPrecommitGpaPages',                   #winhvr.sys
    0x00BF: 'HvUncommitGpaPages',                    #winhvr.sys
    0x00C0: 'HvCallReserved00',
    0x00C1: 'HvCallReserved00', 
    0x00C2: 'HvDispatchVp',                          #winhvr.sys, fast hypercall
    0x00C3: 'HvUnknown25', 
    0x00C4: 'HvHandleDmaTargetExposeToVtl0',         #securekernel.exe SkpnppHandleDmaTargetExposeToVtl0
    0x00C5: 'HvUnknown26',
    0x00C6: 'HvCallReserved00',
    0x00C7: 'HvUnknown27',
    0x00C8: 'HvUnknown28', 
    0x00C9: 'HvGetGpaPagesAccessState',              #winhvr.sys
    0x00CA: 'HvUnknown29',
    0x00CB: 'HvCallReserved00', 
    0x00CC: 'HvQueryVtlProtectionMaskRange',         #winhvr.sys
    0x00CD: 'HvModifyVtlProtectionMaskRange',        #winhvr.sys
    0x00CE: 'HvCallReserved00',
    0x00CF: 'HvCallReserved00',
    0x00D1: 'HvCallReserved00', 
    0x00D2: 'HvAcquireSparseGpaPageHostAccess',      #winhvr.sys
    0x00D3: 'HvReleaseSparseGpaPageHostAccess',      #winhvr.sys
    0x00D4: 'HvCheckSparseGpaPageVtlAccess',         #winhvr.sys
    0x00D5: 'HvCallReserved00',
    0x00D6: 'HvCallReserved00',
    0x00D7: 'HvAcquireSparseSpaPageHostAccess',      #winhvr.sys
    0x00D8: 'HvReleaseSparseSpaPageHostAccess',      #winhvr.sys
    0x00D9: 'HvModifySparseGpaPageHostVisibility',   #winhv.sys
    0x00DA: 'HvCallReserved00', 
    0x00DB: 'HvAcceptGpaPages',                      #winhvr.sys
    0x00DC: 'HvUnknown30',
    0x00DD: 'HvUnknown31',
    0x00DE: 'HvUnknown32',
    0x00DF: 'HvUnknown33', 
    0x00E0: 'HvQueryDeviceInterruptTarget',          #winhvr.sys
    0x00E1: 'HvMapVpRegisterPage',                   #winhvr.sys (HvMapVpStatePage in Windows 10)
    0x00E2: 'HvUnknown34', 
    0x00E3: 'HvGetXsaveData',                        #winhvr.sys
    0x00E4: 'HvSetXsaveData',                        #winhvr.sys
    0x00E5: 'HvGetLocalInterruptControllerState',    #winhvr.sys
    0x00E6: 'HvSetLocalInterruptControllerState',    #winhvr.sys
    0x00E7: 'HvCreateIptBuffers',                    #winhvr.sys (Windows 10)
    0x00E8: 'HvDeleteIptBuffers',                    #winhvr.sys (Windows 10)
}
...
if hvStats == 0xffffffffffffffffL:
    ...
    AddConst(hvStats,"VIRTUAL_PROCESSOR_HYPERCALL02",0x45)
    AddConst(hvStats,"FLUSH_PHYSICAL_ADDRESS_SPACE",0x8F)
    AddConst(hvStats,"FLUSH_PHYSICAL_ADDRESS_LIST",0x90)
...
#hvCallCount = 0xE6 #count of hypercalls in Windows Server 2019
#hvCallCount = 0xE8 #count of hypercalls in Windows 10 19H1
...
del_items(HvCallReserved00, flags=0, size=1)
...
OpEnumEx(StartAddress+8+j*2, 0, hvStats, 0)
